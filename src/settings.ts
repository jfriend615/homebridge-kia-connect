...
export const ACTION_STATUS_POLL_INTERVAL_MS = 5000;
export const ACTION_STATUS_MAX_ATTEMPTS = 24; // 2 min max wait
export const SESSION_LIFETIME_MS = 23 * 60 * 60 * 1000;
